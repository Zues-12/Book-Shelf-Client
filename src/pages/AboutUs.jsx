...
const AboutUs = () => {
  return (
    <div className="bg-black h-auto w-full lg:flex animate-slidein opacity-0 [--slidein-delay:700ms]">
      <div>
        <h1 className=" px-2 py-4 text-4xl font-bold text-white">About Us</h1>
      ...
      <div className='lg:mt-14 lg:mb-14 mr-6 w-[70%] h-[10%]'>
